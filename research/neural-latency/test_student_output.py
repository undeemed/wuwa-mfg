...
def main():
    ...
    with torch.inference_mode():
        ...
        for name, folder in args.model:
            ...
            assert architecture['variant'] in ('hierarchical','hierarchical-film','hierarchical-latent') and architecture['width'] in (16, 32)
            ...
            model = GradedStudent(HierarchicalStudent(architecture['width'], 2, conditioned=architecture['variant'] in ('hierarchical-film','hierarchical-latent'), latent=architecture['variant']=='hierarchical-latent'), architecture['explicit_output_grading'])
