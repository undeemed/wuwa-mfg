...
def main():
    ...
    with torch.inference_mode():
        for name,folder in args.model:
            ...
            assert record['controls']==controls and a['variant'] in ('hierarchical','hierarchical-film','hierarchical-latent') and a['width'] in (16,32)
            ...
            model=GradedStudent(HierarchicalStudent(a['width'],2,conditioned=a['variant'] in ('hierarchical-film','hierarchical-latent'), latent=a['variant']=='hierarchical-latent'),a['explicit_output_grading'])
